      ...
      <CardHeader className="pb-3 relative z-10 bg-gradient-to-r from-red-900/50 to-amber-900/50">
        <div className="flex justify-between items-start gap-2">
          <div className="min-w-0 flex-1">
            <CardTitle className="text-base sm:text-lg group-hover:text-yellow-400 transition-colors duration-300 font-bold bg-gradient-to-r from-yellow-400 to-amber-300 bg-clip-text text-transparent leading-tight">
              🎲 {title} 🎲
            </CardTitle>
            <CardDescription className="text-yellow-200/80 group-hover:text-yellow-200 text-xs sm:text-sm leading-tight mt-1">
              🎯 {description}
            </CardDescription>
          </div>
          {timeLeft && (
            <Badge variant="outline" className="bg-yellow-400/20 text-yellow-400 border-yellow-400/50 font-bold text-xs flex-shrink-0">
